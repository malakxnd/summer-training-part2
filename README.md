...
- `best_model/`: Model and tokenizer for English-to-Arabic translation.
- `checkpoint-2000/`: Checkpoint for resuming training.
- CSV and JSON files: Training history and evaluation logs.
